...
#define PRID_IMP_LOONGSON3	0x6305
...
#define PRID_REV_LOONGSON3B	0x0006	/* ÁúÐ¾3b */
...
enum cpu_type_enum {
	 ...
	 */
	CPU_5KC, CPU_20KC, CPU_25KF, CPU_SB1, CPU_SB1A, CPU_LOONGSON2, CPU_LOONGSON3,
...
#define MIPS_ASE_XBURSTMXU	0x80000000 /*  */
