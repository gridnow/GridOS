...
#ifndef __ASM_MACH_LOONGSON_DEFINE_H
#define __ASM_MACH_LOONGSON_DEFINE_H

#include <asm/addrspace.h>

/* irq.c */
extern void bonito_irqdispatch(void);
/* bonito-irq.c loongson internal northbridge initialization */
extern void bonito_irq_init(void);

/* 2f/irq.c */
void init_irq_2f(void);
void irq_dispatch_2f(unsigned int pending);

/* loongson 3 */
void init_irq_loongson3();
void loongson3_ipi_interrupt();
void irq_dispatch_loongson_3(unsigned int pending);
void ht_irq_init(void);
...
#endif /* __ASM_MACH_LOONGSON_DEFINE_H */
